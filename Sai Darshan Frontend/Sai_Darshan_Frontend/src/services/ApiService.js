...
class ApiService {
  ...
  async cancelAartiBooking(bookingId) {
    try {
      const response = await apiClient.post(`/user/aarti/bookings/${bookingId}/cancel`);
      return response.data;
    } catch (error) {
      throw new Error(error.response?.data?.message || 'Failed to cancel aarti booking');
    }
  }

  async cancelPoojaBooking(bookingId) {
    try {
      const response = await apiClient.post(`/api/pooja/bookings/${bookingId}/cancel`);
      return response.data;
    } catch (error) {
      throw new Error(error.response?.data?.message || 'Failed to cancel pooja booking');
    }
  }
  ...
  async getAartiTypes() {
    try {
      const response = await apiClient.get('/user/aarti/types');
      return response.data;
    } catch (error) {
  ...
  async getAartiCapacity(aartiType, date) {
    try {
      const response = await apiClient.get('/user/aarti/capacity', { 
        params: { aartiType, date } 
      });
      return response.data;
    } catch (error) {
      throw new Error(error.response?.data?.message || 'Failed to get aarti capacity');
    }
  }

  async getAartiSchedule(date) {
    try {
      const response = await apiClient.get('/user/aarti/schedule', { params: { date } });
      return response.data;
    } catch (error) {
  ...
  async getAartiPrices() {
    try {
      const response = await apiClient.get('/user/aarti/prices');
      return response.data;
    } catch (error) {
  ...
  async bookAarti(bookingData) {
    try {
      const response = await apiClient.post('/user/aarti/book', bookingData);
      return response.data;
    } catch (error) {
  ...
  async getUserAartiBookings(userId) {
    try {
      const response = await apiClient.get(`/user/aarti/bookings/user/${userId}`);
      return response.data;
    } catch (error) {
  ...
  async getPoojaTypes() {
    try {
      const response = await apiClient.get('/api/pooja/types');
      return response.data;
    } catch (error) {
  ...
  async getPoojaTimeSlots() {
    try {
      const response = await apiClient.get('/api/pooja/time-slots');
      return response.data;
    } catch (error) {
      throw new Error(error.response?.data?.message || 'Failed to get pooja time slots');
    }
  }

  async getPoojaSlotCapacity(date, timeSlot) {
    try {
      const response = await apiClient.get('/api/pooja/slot-capacity', { 
        params: { date, timeSlot } 
      });
      return response.data;
    } catch (error) {
      throw new Error(error.response?.data?.message || 'Failed to get slot capacity');
    }
  }

  async bookPooja(userId, bookingData) {
    try {
      const response = await apiClient.post('/api/pooja/bookings', bookingData, {
        params: { userId }
      });
      return response.data;
    } catch (error) {
  ...
  async getUserPoojaBookings(userId) {
    try {
      const response = await apiClient.get(`/api/pooja/bookings/user/${userId}`);
      return response.data;
    } catch (error) {
  ...
  // Admin Darshan Slot Management
  async getAllDarshanSlots() {
    try {
      const response = await apiClient.get('/admin/darshan/slots');
      return response.data;
    } catch (error) {
      throw new Error(error.response?.data?.message || 'Failed to get darshan slots');
    }
  }

  async createDarshanSlot(slotData) {
    try {
      const response = await apiClient.post('/admin/darshan/slots', slotData);
      return response.data;
    } catch (error) {
      throw new Error(error.response?.data?.message || 'Failed to create darshan slot');
    }
  }

  async updateDarshanSlot(slotId, slotData) {
    try {
      const response = await apiClient.put(`/admin/darshan/slots/${slotId}`, slotData);
      return response.data;
    } catch (error) {
      throw new Error(error.response?.data?.message || 'Failed to update darshan slot');
    }
  }

  async deleteDarshanSlot(slotId) {
    try {
      const response = await apiClient.delete(`/admin/darshan/slots/${slotId}`);
      return response.data;
    } catch (error) {
      throw new Error(error.response?.data?.message || 'Failed to delete darshan slot');
    }
  }
